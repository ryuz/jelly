...
module jelly3_jfive_load_queue
    ...
    always_ff @(posedge clk ) begin
        if ( reset ) begin
            ...
            que_rd_en    <= next_rd_en & next_valid;
