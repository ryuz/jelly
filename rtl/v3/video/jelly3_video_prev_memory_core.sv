...
module jelly3_video_prev_memory_core
        #(
            parameter   int     MEM_DEPTH    = 640 * 480                    ,
    ...
    localparam  int     DATA_BITS    = m_axi4s.DATA_BITS        ;
    ...
    jelly3_ram_simple_dualport
        ...
        u_ram_simple_dualport
            (
                .wr_clk         (s_axi4s.aclk   ),
                .wr_en          (s_axi4s.aclken ),
                .wr_addr        ,
                .wr_din         ,
                
                .rd_clk         (s_axi4s.aclk   ),
                .rd_en          (s_axi4s.aclken ),
                .rd_regcke      (s_axi4s.aclken ),
                .rd_addr        ,
                .rd_dout        
            );
