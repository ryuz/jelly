...
module tb_main
    ...
    localparam          FILE_NAME       = "../img_128x128.pgm";
    localparam  int     FILE_IMG_WIDTH  = 128;
    localparam  int     FILE_IMG_HEIGHT = 128;
...
//    assign mat_src.cols = cols_t'(IMG_WIDTH );
    ...
    parameter   bit     [NUM-1:0]   INIT_PARAM_ENABLE   = 4'b1111   ;
    parameter   bit     [NUM-1:0]   INIT_PARAM_DILATION = 4'b0110   ;
    ...
    jelly3_img_morphology_filter
            #(
                ...
                .INIT_PARAM_ENABLE  (INIT_PARAM_ENABLE  ),
                .INIT_PARAM_DILATION(INIT_PARAM_DILATION),
                .INIT_PARAM_FILTER  (INIT_PARAM_FILTER  )
            )
        u_jelly3_img_morphology_filter
            (
                .in_update_req      (1'b1               ),
                .s_img              (mat_src            ),
                .m_img              (mat_dst            ),
