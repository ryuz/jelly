...
int main(int argc, char** argv)
{
    ...
    mng->AddNode(jsim::ResetNode_Create(&top->video_aresetn, 100, false));
    mng->AddNode(jsim::ClockNode_Create(&top->video_aclk, 1000.0/150.0));
    mng->AddNode(jsim::ResetNode_Create(&top->mem_aresetn, 100, false));
    mng->AddNode(jsim::ClockNode_Create(&top->mem_aclk, 1000.0/300.0));
