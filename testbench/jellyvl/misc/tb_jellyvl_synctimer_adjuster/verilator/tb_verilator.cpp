...
int main(int argc, char** argv)
{
    ...
    mng->AddNode(jsim::ClockNode_Create(&top->ref_clk, 1.0));
//    mng->AddNode(jsim::ClockNode_Create(&top->clk, 1000.0/300.0 * 0.999));
    mng->AddNode(jsim::ClockNode_Create(&top->clk, 1000.0/300.0 * 1.001));
//  mng->AddNode(jsim::ClockNode_Create(&top->clk, 1000.0/250.0));
