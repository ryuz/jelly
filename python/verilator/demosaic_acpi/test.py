...
# src_bayer = cv2.imread("../../../dataset/images/windowswallpaper/Chrysanthemum_320x240_bayer10.pgm", cv2.IMREAD_UNCHANGED)
# src_bayer = cv2.imread("../../../dataset/images/windowswallpaper/Penguins_640x480_bayer10.pgm", cv2.IMREAD_UNCHANGED)
