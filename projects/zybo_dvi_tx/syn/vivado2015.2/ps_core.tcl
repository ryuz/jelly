...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ASSOCIATED_BUSIF {m_axi4l_peri00}  ] $peri_aclk
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.MI_PROTOCOL {AXI4LITE}  ] $axi_protocol_converter_0
