...
\
  ...
  connect_bd_net -net in_irq0_1  [get_bd_ports in_irq0] \
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
