...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ether_clk [ create_bd_port -dir O -type clk ether_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {ether_reset} \
 ] $ether_clk
  set ether_reset [ create_bd_port -dir O -from 0 -to 0 -type rst ether_reset ]
  set fan_en [ create_bd_port -dir O -from 0 -to 0 fan_en ]
  set in_clk25 [ create_bd_port -dir I -type clk -freq_hz 25000000 in_clk25 ]
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_JITTER {184.676} \
    CONFIG.CLKOUT1_PHASE_ERROR {221.516} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.000} \
    CONFIG.CLKOUT2_JITTER {159.172} \
    CONFIG.CLKOUT2_PHASE_ERROR {223.191} \
  ...
  connect_bd_net -net clk_in1_0_1 [get_bd_ports in_clk25] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_ports ether_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_ports ether_reset]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins clk_wiz_0/resetn]
