...
set_max_delay -datapath_only -from [get_clocks clk_fpga_0]  -to [get_clocks clk_out1_clkgen] 10.0
set_max_delay -datapath_only -from [get_clocks clk_out1_clkgen]  -to [get_clocks clk_fpga_0] 10.0
...
# PMOD_B
set_property PACKAGE_PIN T20 [get_ports {pmod_jb_p[1]}]
set_property PACKAGE_PIN V20 [get_ports {pmod_jb_p[2]}]
set_property PACKAGE_PIN Y18 [get_ports {pmod_jb_p[3]}]
set_property PACKAGE_PIN W18 [get_ports {pmod_jb_p[4]}]
