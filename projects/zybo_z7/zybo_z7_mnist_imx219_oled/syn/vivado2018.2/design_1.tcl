...
proc create_root_design { parentCell } {
  ...
  set out_oled_clk [ create_bd_port -dir O -type clk out_oled_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {out_oled_reset} \
   CONFIG.FREQ_HZ {62500000} \
 ] $out_oled_clk
  set out_oled_clk_x7 [ create_bd_port -dir O -type clk out_oled_clk_x7 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {437500000} \
 ] $out_oled_clk_x7
  set out_oled_reset [ create_bd_port -dir O -from 0 -to 0 -type rst out_oled_reset ]
  ...
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins clk_wiz_0/clk_out4] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_ports out_oled_clk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins proc_sys_reset_3/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_ports out_oled_clk_x7] [get_bd_pins clk_wiz_1/clk_out2]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_3/dcm_locked]
  ...
  connect_bd_net -net proc_sys_reset_3_peripheral_reset [get_bd_ports out_oled_reset] [get_bd_pins proc_sys_reset_3/peripheral_reset]
  ...
  connect_bd_net -net reset_0_1 [get_bd_ports sys_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins clk_wiz_1/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in]
