...
module rmii_phy
        ...
        (
            ...
            output  var logic           m_axi4s_rx_tfirst   ,
            output  var logic           m_axi4s_rx_tlast    ,
            output  var logic   [7:0]   m_axi4s_rx_tdata    ,
            output  var logic           m_axi4s_rx_tvalid   ,

            input   var logic           s_axi4s_tx_tlast    ,
            input   var logic   [7:0]   s_axi4s_tx_tdata    ,
            input   var logic           s_axi4s_tx_tvalid   ,
            output  var logic           s_axi4s_tx_tready   ,

            input   var logic           rmii_refclk         ,
            output  var logic           rmii_txen           ,
            output  var logic   [1:0]   rmii_tx             ,
            input   var logic   [1:0]   rmii_rx             ,
            input   var logic           rmii_crs            ,
            input   var logic           rmii_mdc            ,
            output  var logic           rmii_mdio_t         ,
            output  var logic           rmii_mdio_o         ,
            input   var logic           rmii_mdio_i
        );
...
//    assign rmii_clk = rmii_refclk;
    BUFG    u_bufg  (.I(rmii_refclk), .O(rmii_clk));
