...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_ports m_axi4l_peri_aclk] [get_bd_ports out_clk125] [get_bd_ports s_axi4_mem_aclk] [get_bd_pins clk_wiz_0/clk_out4] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk]
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_ports core_clk] [get_bd_ports out_clk200] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_ports m_axi4l_peri_aresetn] [get_bd_ports s_axi4_mem_aresetn] [get_bd_pins proc_sys_reset_1/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_reset [get_bd_ports core_reset] [get_bd_pins proc_sys_reset_2/peripheral_reset]
  connect_bd_net -net reset_0_1 [get_bd_ports in_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in]
