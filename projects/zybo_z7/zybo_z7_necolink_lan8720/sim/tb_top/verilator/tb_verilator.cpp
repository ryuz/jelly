...
int main(int argc, char** argv)
{
    ...
    mng->AddNode(jsim::ResetNode_Create(&top->dmy_reset,  100));
    mng->AddNode(jsim::ClockNode_Create(&top->dmy_clk50,  1000.0/50.0));
    mng->AddNode(jsim::ClockNode_Create(&top->dmy_clk100, 1000.0/100.0));
    mng->AddNode(jsim::ClockNode_Create(&top->dmy_clk125, 1000.0/125.0));
    mng->AddNode(jsim::ClockNode_Create(&top->dmy_clk200, 1000.0/200.0));
    mng->AddNode(jsim::ClockNode_Create(&top->dmy_clk250, 1000.0/250.0));
