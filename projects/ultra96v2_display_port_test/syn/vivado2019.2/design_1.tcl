...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set dp_external_custom_event1_0 [ create_bd_port -dir I dp_external_custom_event1_0 ]
  set dp_external_custom_event2_0 [ create_bd_port -dir I dp_external_custom_event2_0 ]
  set dp_external_vsync_event_0 [ create_bd_port -dir I dp_external_vsync_event_0 ]
  set dp_live_gfx_alpha_in_0 [ create_bd_port -dir I -from 7 -to 0 dp_live_gfx_alpha_in_0 ]
  set dp_live_gfx_pixel1_in_0 [ create_bd_port -dir I -from 35 -to 0 dp_live_gfx_pixel1_in_0 ]
  set dp_live_video_de_out_0 [ create_bd_port -dir O dp_live_video_de_out_0 ]
  set dp_live_video_in_de_0 [ create_bd_port -dir I dp_live_video_in_de_0 ]
  set dp_live_video_in_hsync_0 [ create_bd_port -dir I dp_live_video_in_hsync_0 ]
  set dp_live_video_in_pixel1_0 [ create_bd_port -dir I -from 35 -to 0 dp_live_video_in_pixel1_0 ]
  set dp_live_video_in_vsync_0 [ create_bd_port -dir I dp_live_video_in_vsync_0 ]
  set dp_video_in_clk_0 [ create_bd_port -dir I dp_video_in_clk_0 ]
  set dp_video_out_hsync_0 [ create_bd_port -dir O dp_video_out_hsync_0 ]
  set dp_video_out_pixel1_0 [ create_bd_port -dir O -from 35 -to 0 dp_video_out_pixel1_0 ]
  set dp_video_out_vsync_0 [ create_bd_port -dir O dp_video_out_vsync_0 ]
  set dp_video_ref_clk_0 [ create_bd_port -dir O -type clk dp_video_ref_clk_0 ]
  ...
  connect_bd_net -net dp_external_custom_event1_0_1 [get_bd_ports dp_external_custom_event1_0] [get_bd_pins zynq_ultra_ps_e_0/dp_external_custom_event1]
  connect_bd_net -net dp_external_custom_event2_0_1 [get_bd_ports dp_external_custom_event2_0] [get_bd_pins zynq_ultra_ps_e_0/dp_external_custom_event2]
  connect_bd_net -net dp_external_vsync_event_0_1 [get_bd_ports dp_external_vsync_event_0] [get_bd_pins zynq_ultra_ps_e_0/dp_external_vsync_event]
  connect_bd_net -net dp_live_gfx_alpha_in_0_1 [get_bd_ports dp_live_gfx_alpha_in_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_gfx_alpha_in]
  connect_bd_net -net dp_live_gfx_pixel1_in_0_1 [get_bd_ports dp_live_gfx_pixel1_in_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_gfx_pixel1_in]
  connect_bd_net -net dp_live_video_in_de_0_1 [get_bd_ports dp_live_video_in_de_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_de]
  connect_bd_net -net dp_live_video_in_hsync_0_1 [get_bd_ports dp_live_video_in_hsync_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_hsync]
  connect_bd_net -net dp_live_video_in_pixel1_0_1 [get_bd_ports dp_live_video_in_pixel1_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_pixel1]
  connect_bd_net -net dp_live_video_in_vsync_0_1 [get_bd_ports dp_live_video_in_vsync_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_vsync]
  connect_bd_net -net dp_video_in_clk_0_1 [get_bd_ports dp_video_in_clk_0] [get_bd_pins zynq_ultra_ps_e_0/dp_video_in_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_live_video_de_out [get_bd_ports dp_live_video_de_out_0] [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_de_out]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_video_out_hsync [get_bd_ports dp_video_out_hsync_0] [get_bd_pins zynq_ultra_ps_e_0/dp_video_out_hsync]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_video_out_pixel1 [get_bd_ports dp_video_out_pixel1_0] [get_bd_pins zynq_ultra_ps_e_0/dp_video_out_pixel1]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_video_out_vsync [get_bd_ports dp_video_out_vsync_0] [get_bd_pins zynq_ultra_ps_e_0/dp_video_out_vsync]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_video_ref_clk [get_bd_ports dp_video_ref_clk_0] [get_bd_pins zynq_ultra_ps_e_0/dp_video_ref_clk]
