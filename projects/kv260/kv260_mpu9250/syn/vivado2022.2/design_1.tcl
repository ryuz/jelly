...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set in_irq0 [ create_bd_port -dir I -from 7 -to 0 -type intr in_irq0 ]
  set_property -dict [ list \
   CONFIG.PortWidth {8} \
 ] $in_irq0
...
\
  ...
  connect_bd_net -net nfiq0_lpd_rpu_1 [get_bd_ports nfiq0_lpd_rpu] [get_bd_pins zynq_ultra_ps_e_0/nfiq0_lpd_rpu]
  connect_bd_net -net nfiq1_lpd_rpu_1 [get_bd_ports nfiq1_lpd_rpu] [get_bd_pins zynq_ultra_ps_e_0/nfiq1_lpd_rpu]
  connect_bd_net -net nirq0_lpd_rpu_1 [get_bd_ports nirq0_lpd_rpu] [get_bd_pins zynq_ultra_ps_e_0/nirq0_lpd_rpu]
  connect_bd_net -net nirq1_lpd_rpu_1 [get_bd_ports nirq1_lpd_rpu] [get_bd_pins zynq_ultra_ps_e_0/nirq1_lpd_rpu]
