...
#define REG_BIN_TBL(x)              (0x40 +(x))
    ...
    wb->ExecWrite(reg_bin + REG_BIN_PARAM_END, 3, 0xf);
    wb->ExecWrite(reg_bin + REG_BIN_TBL(0), 0x10, 0xf);
    wb->ExecWrite(reg_bin + REG_BIN_TBL(1), 0x20, 0xf);
    wb->ExecWrite(reg_bin + REG_BIN_TBL(2), 0x30, 0xf);
