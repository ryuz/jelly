# Kria KV260 で JFive で ハードウェアマルチスレッドを動かすサンプル

## 概要

Kria KV260 で JFive (RISC-V 風の独自プロセッサ) でハードウェアマルチスレッドを動かすサンプルを動かすサンプルです。
...
なお、例によって、最小の命令セットである RV32I 命令セットのみの簡易版CPUコアとなっており、割り込みすら実装していません。
