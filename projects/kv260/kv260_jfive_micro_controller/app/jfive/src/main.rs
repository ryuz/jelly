...
//  println!("val : 0x{:x}", val_u32);
    ...
    // LEDチカ 開始(実機用)
    let mmio_gpio0 = 0x10000000  as *mut i32;
    let mmio_gpio1 = 0x10000004  as *mut i32;
    let mut gpio0 = 0;
    let mut gpio1 = 0;
    let mut counter0 = 0;
    let mut counter1 = 0;
    loop {
        ...
        core::ptr::write_volatile(mmio_gpio0, gpio0);
        core::ptr::write_volatile(mmio_gpio1, gpio1);
    }
}
