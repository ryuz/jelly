...
proc create_root_design { parentCell } {
  ...
  # Create instance: jelly2_rtos_axi4l_0, and set properties
  set block_name jelly2_rtos_axi4l
  set block_cell_name jelly2_rtos_axi4l_0
  if { [catch {set jelly2_rtos_axi4l_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $jelly2_rtos_axi4l_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.FLGPTN_WIDTH {32} $jelly2_rtos_axi4l_0
...
\
  ...
  connect_bd_intf_net -intf_net axi_protocol_convert_0_M_AXI [get_bd_intf_pins axi_protocol_convert_0/M_AXI] [get_bd_intf_pins jelly2_rtos_axi4l_0/s_axi4l]
  ...
  connect_bd_net -net jelly2_rtos_axi4l_0_irq [get_bd_pins jelly2_rtos_axi4l_0/irq] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins jelly2_rtos_axi4l_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins zynq_ultra_ps_e_0/nfiq0_lpd_rpu]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins zynq_ultra_ps_e_0/nfiq1_lpd_rpu] [get_bd_pins zynq_ultra_ps_e_0/nirq0_lpd_rpu] [get_bd_pins zynq_ultra_ps_e_0/nirq1_lpd_rpu]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins jelly2_rtos_axi4l_0/set_flg] [get_bd_pins xlconstant_1/dout]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins jelly2_rtos_axi4l_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  ...
  assign_bd_address -offset 0x80000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs jelly2_rtos_axi4l_0/s_axi4l/reg0] -force
