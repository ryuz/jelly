...
CONFIG.WUSER_WIDTH {0} \
  ...
  set s_axi4_mem01 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi4_mem01 ]
  set_property -dict [ list \
CONFIG.ADDR_WIDTH {32} \
CONFIG.ARUSER_WIDTH {0} \
CONFIG.AWUSER_WIDTH {0} \
...
CONFIG.WUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {s_axi4_mem01} \
 ] $mem_aclk
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  set system_cache_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_cache:3.1 system_cache_0 ]
  set_property -dict [ list \
...
CONFIG.C_S0_AXI_GEN_DATA_WIDTH {32} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins system_cache_0/M_AXI]
  ...
  connect_bd_intf_net -intf_net s_axi4_mem00_1 [get_bd_intf_ports s_axi4_mem00] [get_bd_intf_pins system_cache_0/S0_AXI_GEN]
  connect_bd_intf_net -intf_net s_axi_mem01_1 [get_bd_intf_ports s_axi4_mem01] [get_bd_intf_pins axi_interconnect_2/S00_AXI]

  # Create port connections
  connect_bd_net -net proc_sys_reset_mem_interconnect_aresetn [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_2/ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins proc_sys_reset_mem/interconnect_aresetn] [get_bd_pins system_cache_0/ARESETN]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports mem_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins proc_sys_reset_mem/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins system_cache_0/ACLK]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces s_axi4_mem01] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port video_clk -pg 1 -y 240 -defaultsOSRD
preplace port DDR -pg 1 -y 40 -defaultsOSRD
preplace port mem_aclk -pg 1 -y 120 -defaultsOSRD
preplace port video_clk_x5 -pg 1 -y 270 -defaultsOSRD
preplace port s_axi4_mem00 -pg 1 -y 730 -defaultsOSRD
preplace port s_axi4_mem01 -pg 1 -y 1040 -defaultsOSRD
preplace port m_axi4l_peri00 -pg 1 -y 80 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port peri_aclk -pg 1 -y 160 -defaultsOSRD
preplace portBus mem_aresetn -pg 1 -y 140 -defaultsOSRD
preplace portBus peri_aresetn -pg 1 -y 180 -defaultsOSRD
preplace portBus video_reset -pg 1 -y 220 -defaultsOSRD
preplace inst axi_protocol_converter_0 -pg 1 -lvl 4 -y 770 -defaultsOSRD
preplace inst proc_sys_reset_peri -pg 1 -lvl 3 -y 320 -defaultsOSRD
preplace inst proc_sys_reset_mem -pg 1 -lvl 3 -y 100 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 4 -y 130 -defaultsOSRD
preplace inst proc_sys_reset_video -pg 1 -lvl 3 -y 540 -defaultsOSRD
preplace inst axi_interconnect_1 -pg 1 -lvl 2 -y 810 -defaultsOSRD
preplace inst axi_interconnect_2 -pg 1 -lvl 2 -y 1100 -defaultsOSRD
preplace inst system_cache_0 -pg 1 -lvl 1 -y 750 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 3 -y 1100 -defaultsOSRD
preplace netloc s_axi_mem01_1 1 0 2 NJ 1040 N
preplace netloc processing_system7_0_DDR 1 3 2 1250 280 NJ
preplace netloc processing_system7_0_FCLK_CLK3 1 3 2 1300 270 NJ
preplace netloc proc_sys_reset_mem_peripheral_aresetn 1 3 2 1210 0 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 3 1 1290
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 2 750 450 1190
preplace netloc s_axi4_mem00_1 1 0 1 N
preplace netloc proc_sys_reset_video_peripheral_reset 1 3 2 NJ 540 1660
preplace netloc processing_system7_0_FIXED_IO 1 3 2 1220 10 NJ
preplace netloc S00_AXI_1 1 3 2 1310 310 1600
preplace netloc proc_sys_reset_mem_interconnect_aresetn 1 0 4 -70 660 NJ 660 NJ 660 1200
preplace netloc S00_AXI_2 1 1 1 N
preplace netloc axi_interconnect_0_M00_AXI 1 4 1 1590
preplace netloc processing_system7_0_FCLK_CLK0 1 2 3 760 230 1240 250 NJ
preplace netloc proc_sys_reset_peri_peripheral_aresetn 1 3 2 1260 290 NJ
preplace netloc axi_interconnect_2_M00_AXI 1 2 1 N
preplace netloc axi_interconnect_1_M00_AXI 1 2 1 730
preplace netloc processing_system7_0_FCLK_CLK1 1 0 5 -60 680 170 680 740 430 1230 430 NJ
preplace netloc proc_sys_reset_peri_interconnect_aresetn 1 3 1 1280
preplace netloc processing_system7_0_FCLK_CLK2 1 2 3 770 440 1270 260 NJ
levelinfo -pg 1 -90 70 590 980 1450 1680 -top -10 -bot 1260
",
}
