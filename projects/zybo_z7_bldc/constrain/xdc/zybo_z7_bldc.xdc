...
set_property PACKAGE_PIN V12 [get_ports bldc_u_en]
set_property PACKAGE_PIN W16 [get_ports bldc_v_en]
set_property PACKAGE_PIN J15 [get_ports bldc_w_en]
set_property PACKAGE_PIN V13 [get_ports bldc_u_hl]
set_property PACKAGE_PIN U17 [get_ports bldc_v_hl]
set_property PACKAGE_PIN T17 [get_ports bldc_w_hl]
set_property IOSTANDARD LVCMOS33 [get_ports bldc_u_en]
set_property IOSTANDARD LVCMOS33 [get_ports bldc_v_en]
set_property IOSTANDARD LVCMOS33 [get_ports bldc_w_en]
set_property IOSTANDARD LVCMOS33 [get_ports bldc_u_hl]
set_property IOSTANDARD LVCMOS33 [get_ports bldc_v_hl]
set_property IOSTANDARD LVCMOS33 [get_ports bldc_w_hl]
