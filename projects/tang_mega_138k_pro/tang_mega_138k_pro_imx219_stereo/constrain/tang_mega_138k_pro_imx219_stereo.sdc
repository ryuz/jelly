...
set_clock_groups -asynchronous -group [get_clocks {sys_clk}] -group [get_clocks {cam_clk}] -group [get_clocks {dvi_clk}] -group [get_clocks {u_imx219_mipi_rx_cam0/mipi_dphy_rx_clk}] -group [get_clocks {u_imx219_mipi_rx_cam1/mipi_dphy_rx_clk}]
