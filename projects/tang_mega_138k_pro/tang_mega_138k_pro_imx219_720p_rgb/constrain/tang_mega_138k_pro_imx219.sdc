...
create_generated_clock -name cam_clk    -source [get_ports {in_clk50}] -master_clock in_clk50 -divide_by 14 -multiply_by 51 [get_pins {u_Gowin_PLL_mipi/PLL_inst/CLKOUT0}]
