...
create_generated_clock -name cam_clk    -source [get_ports {in_clk50}] -master_clock in_clk50 -divide_by 20 -multiply_by 18 [get_pins {u_Gowin_PLL/u_pll/PLL_inst/CLKOUT1}]
