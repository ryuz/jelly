...
int main(int argc, char** argv)
{
    ...
    mng->AddNode(jsim::ClockNode_Create(&top->sys_clk,  1000.0/50.0));
    mng->AddNode(jsim::ClockNode_Create(&top->dphy_clk, 1000.0/91.2));
    mng->AddNode(jsim::ClockNode_Create(&top->cam_clk,  1000.0/200.0));
    mng->AddNode(jsim::ClockNode_Create(&top->dvi_clk,  1000.0/25.0));
