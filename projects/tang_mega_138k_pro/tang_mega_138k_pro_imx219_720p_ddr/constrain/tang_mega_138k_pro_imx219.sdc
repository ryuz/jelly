...
set_clock_groups -asynchronous -group [get_clocks {dma_clk}] -group [get_clocks {ddr3_clk}] -group [get_clocks {in_clk50}] -group [get_clocks {sys_clk}] -group [get_clocks {dvi_clk}] -group [get_clocks {mipi0_dphy_rx_clk}]
