...
set_property PACKAGE_PIN B3 [get_ports {python_data_p[1]}]
set_property PACKAGE_PIN A2 [get_ports {python_data_n[1]}]
set_property PACKAGE_PIN E2 [get_ports {python_data_p[2]}]
set_property PACKAGE_PIN D2 [get_ports {python_data_n[2]}]
set_property PACKAGE_PIN D3 [get_ports {python_data_p[3]}]
set_property PACKAGE_PIN C3 [get_ports {python_data_n[3]}]
set_property PACKAGE_PIN E4 [get_ports python_sync_p]
set_property PACKAGE_PIN D4 [get_ports python_sync_n]
...
set_property PACKAGE_PIN F12 [get_ports python_reset_n]
set_property PACKAGE_PIN E12 [get_ports python_clk_pll]
set_property PACKAGE_PIN D12 [get_ports python_ss_n]
set_property PACKAGE_PIN D13 [get_ports python_mosi]
set_property PACKAGE_PIN G14 [get_ports python_miso]
set_property PACKAGE_PIN F14 [get_ports python_sck]
set_property PACKAGE_PIN F13 [get_ports {python_trigger[0]}]
set_property PACKAGE_PIN E13 [get_ports {python_trigger[1]}]
set_property PACKAGE_PIN D14 [get_ports {python_trigger[2]}]
set_property PACKAGE_PIN C14 [get_ports {python_monitor[0]}]
set_property PACKAGE_PIN J11 [get_ports {python_monitor[1]}]
