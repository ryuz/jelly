...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports ref200_clk] [get_bd_pins proc_sys_reset_ref200/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_mem/ext_reset_in] [get_bd_pins proc_sys_reset_peri/ext_reset_in] [get_bd_pins proc_sys_reset_ref200/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
