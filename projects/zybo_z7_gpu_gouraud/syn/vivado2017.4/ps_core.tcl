...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {s_axi4_mem00} \
 ] $mem_aclk
  ...
  set clk_wiz_vout [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 clk_wiz_vout ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {152.380966} \
   ...
   CONFIG.PCW_CLK1_FREQ {152380966} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins processing_system7_1/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net processing_system7_1_M_AXI_GP0 [get_bd_intf_pins axi_protocol_converter_0/S_AXI] [get_bd_intf_pins processing_system7_1/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports vout_clk] [get_bd_pins clk_wiz_vout/clk_out1] [get_bd_pins proc_sys_reset_video/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports vout_clk_x5] [get_bd_pins clk_wiz_vout/clk_out2]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports ref200_clk] [get_bd_pins proc_sys_reset_ref200/slowest_sync_clk] [get_bd_pins processing_system7_1/FCLK_CLK2]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_vout/locked] [get_bd_pins proc_sys_reset_video/dcm_locked]
  ...
  connect_bd_net -net proc_sys_reset_video_peripheral_reset [get_bd_ports vout_reset] [get_bd_pins proc_sys_reset_video/peripheral_reset]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_mem/ext_reset_in] [get_bd_pins proc_sys_reset_peri/ext_reset_in] [get_bd_pins proc_sys_reset_ref200/ext_reset_in] [get_bd_pins processing_system7_1/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_1_FCLK_CLK1 [get_bd_ports mem_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins proc_sys_reset_mem/slowest_sync_clk] [get_bd_pins processing_system7_1/FCLK_CLK1] [get_bd_pins processing_system7_1/S_AXI_HP0_ACLK]
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins proc_sys_reset_video/ext_reset_in]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_vout/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs m_axi4l_peri00/Reg] SEG_m_axi4l_peri00_Reg
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces s_axi4_mem00] [get_bd_addr_segs processing_system7_1/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_1_HP0_DDR_LOWOCM
