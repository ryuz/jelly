...
connect_debug_port u_ila_0/probe0 [get_nets [list {align_data[0][0]} {align_data[0][1]} {align_data[0][2]} {align_data[0][3]} {align_data[0][4]} {align_data[0][5]} {align_data[0][6]} {align_data[0][7]} {align_data[0][8]} {align_data[0][9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 10 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {align_data[2][0]} {align_data[2][1]} {align_data[2][2]} {align_data[2][3]} {align_data[2][4]} {align_data[2][5]} {align_data[2][6]} {align_data[2][7]} {align_data[2][8]} {align_data[2][9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 10 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {align_data[3][0]} {align_data[3][1]} {align_data[3][2]} {align_data[3][3]} {align_data[3][4]} {align_data[3][5]} {align_data[3][6]} {align_data[3][7]} {align_data[3][8]} {align_data[3][9]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe6 [get_nets [list {align_bitslip[0]} {align_bitslip[1]} {align_bitslip[2]} {align_bitslip[3]} {align_bitslip[4]}]]
create_debug_port u_ila_0 probe
