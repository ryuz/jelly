...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_DOMAIN {ps_core_processing_system7_0_0_FCLK_CLK0} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_DOMAIN {ps_core_processing_system7_0_0_FCLK_CLK1} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_ports ref200_clk] [get_bd_pins processing_system7_0/FCLK_CLK3]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces s_axi4_mem00] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
